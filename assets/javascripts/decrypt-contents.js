...
function decryptor_reaction(key_or_keys, password_input, decrypted_content, fallback_used=false) {
    if (key_or_keys) {
        ...
        let encrypted_something = {'mkdocs-encrypted-toc': 'display:none;', 'mySpecialClass': 'color:red;'};
        ...
        let reload_scripts = ["document.getElementById('mkdocs-decrypt-button').addEventListener('click', function() { setTimeout(function() { location.reload(); }, 1000); });"];

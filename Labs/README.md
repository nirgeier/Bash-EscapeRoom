...
| [Room 52](rooms/Room-52.md)   | The Ownership Vault         | `chown`, `chgrp`, `umask`, `id`, `groups`, `stat`              |
...
| [Room 56](rooms/Room-56.md)   | The Process Controller      | `pgrep`, `pkill`, `nohup`, `nice`, `renice`, `killall`         |
